...
CREATE TABLE `acceso` (
  ...
  `modulo` varchar(40) CHARACTER SET utf8 NOT NULL
...
INSERT INTO `acceso` (`idacceso`, `nivel`, `modulo`) VALUES
(1, 1, 'principal'),
(2, 1, 'venta_nueva'),
(3, 1, 'historico_ventas'),
(4, 1, 'productos'),
(5, 1, 'categoriaproducto'),
(6, 1, 'clientes'),
(7, 1, 'pago'),
(8, 2, 'proveedores'),
(9, 2, 'compra_nueva'),
(10, 2, 'historico_compras'),
(11, 4, 'empleados'),
(12, 4, 'categoriaempleado'),
(13, 4, 'novedadempleado'),
(14, 4, 'ivacompra'),
(15, 4, 'ivaventa'),
(16, 4, 'librosueldos'),
(17, 5, 'liquidar'),
(18, 5, 'liquidaciones'),
(19, 5, 'tipo_liquidaciones'),
(20, 5, 'conceptos'),
(21, 5, 'boleta'),
(22, 5, 'historico_liquidacioness');
...
INSERT INTO `asistencia` (`idasistencia`, `fechalogin`, `logout`, `empleado_idempleado`, `tiempotrabajado`) VALUES
(53, '2020-01-01', NULL, 1, 0),
(54, '2020-01-02', NULL, 1, 0),
(55, '2020-02-27', NULL, 2, 0),
(56, '2020-02-27', NULL, 1, 0),
(57, '2020-02-27', NULL, 9, 0),
(58, '2020-02-27', NULL, 9, 0),
(59, '2020-02-28', NULL, 5, 0),
(60, '2020-02-28', NULL, 5, 0),
(61, '2020-02-28', NULL, 9, 0),
(62, '2020-02-28', NULL, 2, 0),
(63, '2020-02-29', NULL, 9, 0),
(64, '2020-02-29', NULL, 1, 0),
(65, '2020-02-29', NULL, 2, 0),
(66, '2020-02-29', NULL, 2, 0),
(67, '2020-02-29', NULL, 2, 0),
(68, '2020-02-29', NULL, 2, 0),
(69, '2020-03-01', NULL, 2, 0),
(70, '2020-03-01', NULL, 2, 0),
(71, '2020-03-01', NULL, 2, 0),
(72, '2020-03-01', NULL, 9, 0),
(73, '2020-03-01', NULL, 2, 0),
(74, '2020-03-02', NULL, 11, 0),
(75, '2020-03-02', NULL, 1, 0),
...
INSERT INTO `cajadeahorro` (`idcajadeahorro`, `nrocuenta`, `banco_idbanco`, `empleado_idempleado`) VALUES
(1, '', 1, 6),
(2, '', 1, 7),
(3, '', 1, 8),
(4, '1234567890', 1, 9),
...
CREATE TABLE `categoriaempleado` (
  ...
  `horasTrabajadas` int(1) NOT NULL
...
INSERT INTO `categoriaempleado` (`idcategoriaempleado`, `nombrecategoria`, `salariobasicocategoria`, `horasTrabajadas`) VALUES
(1, 'Administrativo', 20000, 8),
(2, 'Vendedor', 15000, 8),
(3, 'Inter Administrativo', 10000, 4),
(4, 'Inter Vendedor', 7500, 4);
...
(1, 'Sueldo Basico', 0, 0, 100, 0),
(2, 'Antiguedad', 0, 0, 100, 1),
(3, 'Presentismo', 0, 0, 8.3, 1),
(4, 'Asignacion Familiar por Hijo', 2746, 1, 0, 1),
...
(59, '2020-03-01', '2020-01-01', '2020-01-31', 50, 'Sueldo Enero', 1);
...
CREATE TABLE `novedad` (
  ...
  `empleado_idempleado` int(11) NOT NULL,
  `falta` int(1) DEFAULT NULL,
  `llegadaTarde` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `novedad` (`idNovedad`, `fechaNovedad`, `empleado_idempleado`, `falta`, `llegadaTarde`) VALUES
(10, '2020-01-10', 11, 1, 0),
(11, '2020-01-15', 9, 1, 1);
...
CREATE TABLE `producto` (
  ...
  `ivaproducto` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
