...
<table class='table table-bordered table-striped'>
	...
	<?php while ($row_direccion= mysql_fetch_array($q_direccion)) { ?>
		<tr>
			<td class="col-xs-3 col-sm-3 col-md-3 col-lg-3"><?php echo utf8_encode($row_direccion['nombreprovincia']); ?></td>
			<td class="col-xs-3 col-sm-3 col-md-3 col-lg-3"><?php echo utf8_encode($row_direccion['nombrelocalidad']); ?></td>
			...
			<td class="col-xs-3 col-sm-3 col-md-3 col-lg-3"><?php echo $row_direccion['numero']; ?></td>
		</tr>
		<?php } ?>
	</tbody>
