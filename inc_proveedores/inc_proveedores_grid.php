...
<?php
	 while ($row_proveedor=mysql_fetch_array($q_proveedor)) {
	 	...
	 	<tr>
	 		...
	 		<td class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><?php echo utf8_encode($row_proveedor['nombreprovincia']) ?></td>
	 		<td class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><?php echo utf8_encode($row_proveedor['nombrelocalidad']) ?></td>
