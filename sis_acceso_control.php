...
<?php
     ...
     $myusuario = mysql_query("select * from usuario where nombreusuario =  '".htmlentities($_POST["usuario"])."'",$conexion_weblibreria);
     ...
     if($nmyusuario != 0){
          ...
          $myclave = mysql_query($sql,$conexion_weblibreria);
          ...
          if($nmyclave != 0){
              ...
              // $_SESSION["tipo_usuario"] = mysql_result($myclave,0,3);
               ...
               $insertlogin="INSERT INTO asistencia (empleado_idempleado, fechalogin)
     ...
     mysql_close($conexion_weblibreria);
?>
